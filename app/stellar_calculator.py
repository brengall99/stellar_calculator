...
def calculate_age(birthdate):
    ...
    print(years, days, hours, minutes)
    return years, days, hours, minutes

def calculate_light_age(star_distance_ly):
    print(star_distance_ly)
...
def main():
    ...
    closest_star, closest_distance, closest_constellation_iau = find_closest_star(age_years)
    print(closest_distance)
    
    light_age_years, light_age_days, light_age_hours, light_age_minutes = calculate_light_age(closest_distance)
    
    # Load constellation data
    constellation_data = load_constellation_data()
    
    # Convert IAU code to full name
